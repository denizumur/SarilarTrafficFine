        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ApprovalWorkflowSteps_StepOrder_Positive", "[StepOrder] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentApprovalStepId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TrafficFines_Amount_Positive", "[Amount] > 0");
                    table.ForeignKey(
                        name: "FK_TrafficFines_ApprovalWorkflowSteps_CurrentApprovalStepId",
                        column: x => x.CurrentApprovalStepId,
                        principalTable: "ApprovalWorkflowSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrafficFines_ApprovalWorkflows_ApprovalWorkflowId",
                        column: x => x.ApprovalWorkflowId,
                        principalTable: "ApprovalWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrafficFines_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionByUserName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ActionType = table.Column<int>(type: "int", nullable: false),
                    ActionAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    PreviousState = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    NewState = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    WorkflowStepId = table.Column<int>(type: "int", nullable: true),
                    WorkflowStepOrder = table.Column<int>(type: "int", nullable: true),
                    WorkflowStepName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApprovalHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApprovalHistories_ApprovalWorkflowSteps_WorkflowStepId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistories_TrafficFineId_ActionAt",
                table: "ApprovalHistories",
                columns: new[] { "TrafficFineId", "ActionAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalWorkflowSteps_ApprovalWorkflowId_StepOrder",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrafficFines_ApprovalWorkflowId",
                table: "TrafficFines",
                column: "ApprovalWorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_TrafficFines_CreatedByUserId",
                table: "TrafficFines",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TrafficFines_CurrentApprovalStepId",
                table: "TrafficFines",
                column: "CurrentApprovalStepId");

            migrationBuilder.CreateIndex(
                name: "IX_TrafficFines_Status",
                table: "TrafficFines",
                column: "Status");
