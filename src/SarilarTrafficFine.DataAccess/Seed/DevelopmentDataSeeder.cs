...
public static class DevelopmentDataSeeder
{
        ...
        this IServiceProvider services)
    {
        ...
        if (string.IsNullOrWhiteSpace(demoPassword))
        {
            throw new InvalidOperationException(
                "Development demo kullanıcıları için 'Seed:DemoPassword' yapılandırması bulunamadı.");
        }
        ...
        params string[] roleNames)
    {
        ...
        if (user is null)
        {
            ...
            EnsureSucceeded(
                createResult,
                $"'{email}' demo kullanıcısı oluşturulamadı.");
        }
                     ...
                     StringComparer.Ordinal))
        {
            ...
            EnsureSucceeded(
                roleResult,
                $"'{email}' kullanıcısına '{roleName}' rolü atanamadı.");
        }
    }
